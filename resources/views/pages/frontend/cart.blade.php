        ...
        @forelse ($carts as $item)
            ...
            >
                ...
                <div class="" style="width: 90px; height: 90px">
                    <img
                    src="{{ $item->product->galleries()->exists() ? Storage::url($item->product->galleries->first()->url) : 'data:image/png;base64,iVBORw0KGgoAA
                    AANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII=' }}"
                    alt="chair-1"
        ...
        <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
            ...
            <div class="flex flex-col mb-4">
                ...
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                    <img src="/frontend/src/images/content/courier/logo-jnt.png" alt="jnt"
                ...
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/courier/logo-jne.png" alt="jne"
                        class="object-contain max-h-full"
                    />
                    </button>
                </div>
            ...
            <div class="flex flex-col mb-4">
                ...
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logo-mandiri.png" alt="mandiri"
                        class="object-contain max-h-full"
                    />
                    </button>
                </div>
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logo-bni.png" alt="bni"
                    />
                    </button>
                </div>
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logo-bca.png" alt="bca"
                        class="object-contain max-h-full"
                    />
                    </button>
                </div>
                <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                    >
                    <img src="/frontend/src/images/content/payment/logo-bri.png" alt="bri"
                    />
                    </button>
                </div>
                </div>
            ...
            <div class="text-center">
                <button
                type="submit"
                class="w-full px-6 py-3 text-lg text-black transition-all duration-200 bg-yellow-400 rounded-full focus:bg-black focus:outline-none focus:text-yellow-400"
                >
                Checkout Now
                </button>
            </div>
