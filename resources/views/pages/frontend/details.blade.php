...
<section class="container mx-auto">
    ...
    <div class="flex-1 px-4 md:p-6">
        ...
        @csrf
        <button
            class="transition-all duration-200 bg-yellow-400 text-black focus:bg-black focus:text-yellow-400 rounded-full px-8 py-3 mt-4 inline-flex"
            ><svg
...
<section class="bg-gray-100 px-4 py-16">
    ...
    <div class="flex flex-start mb-4">
        ...
        Complete your Style <br class="" />with what we designed
        </h3>
    </div>
    <div class="flex overflow-x-auto mb-4 -mx-3">
        ...
        <div class="px-3 flex-none" style="width: 320px">
            ...
            <div class="rounded-xl overflow-hidden card-shadow w-full h-full">
                <img
                src="{{ $recommendation->galleries()->exists() ? Storage::url($recommendation->galleries->first()->url) : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII=' }}"
                alt=""
