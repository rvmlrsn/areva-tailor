...
<div class="container px-8 py-12 mx-auto">
    ...
    <div class="flex items-center w-56">
        <a href="{{ route('index') }}">
            <img src="{{ url('frontend/src/images/design/logoAR.svg')}}"
            alt="Areva Tailor - Adalah sebuah website yang menawarkan jasa jahit profesional" />
        </a>
    </div>
    ...
    <div class="w-auto">
        <ul id="menu"
        class="fixed inset-0 flex flex-col items-center justify-center invisible bg-white opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100">
        ...
        <li class="py-6 mx-3 md:py-0">
            <a href="{{ route ('catalog') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-black' : 'md:text-black' }} hover:underline">Catalog</a>
        </li>
        <li class="py-6 mx-3 md:py-0">
            <a href="#contact" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-black' : 'md:text-black' }} hover:underline">Contact</a>
        </li>
        <li class="py-6 mx-3 md:py-0">
            <a href="{{ route('about') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-black' : 'md:text-black' }} hover:underline">About</a>
        </li>
        @auth
        <li class="mx-3 py-6 md:py-0">
        <a href="{{ route('dashboard.index') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-black' : 'md:text-black' }} hover:underline"
            >Dashboard</a
        >
        </li>
        @endauth
        @guest
        <li class="mx-3 py-6 md:py-0">
        <a href="{{ route('login') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-black' : 'md:text-black' }} hover:underline"
            >Login</a
        >
        </li>
        <li class="mx-3 py-6 md:py-0">
        <a href="{{ route('register') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-black' : 'md:text-black' }} hover:underline"
            >Register</a
        >
        </li>
        @endguest
    ...
    <ul class="items-center flex">
        ...
        <li class="ml-6">
            <a id="header-cart" href="{{ route('cart') }}" class="flex items-center justify-center w-8 h-8 cart cart-filled">
            <svg class="fill-current animate-bounce w-6 h-6" width="29" height="25" viewBox="0 0 29 25" fill="none"
