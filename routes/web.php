...
Route::get('/batik', [FrontendController::class, 'batik'])->name('batik');
Route::get('/suit', [FrontendController::class, 'suit'])->name('suit');
Route::get('/pants', [FrontendController::class, 'pants'])->name('pants');
Route::get('/shirt', [FrontendController::class, 'shirt'])->name('shirt');
